...
caminho_base = "Datasets/BasesGCPR"
...
for dir_data in os.listdir(caminho_base):
    ...
    for particao in range(10):
        ...
        if particao == 0: # Realiza seleção de atributos apenas na primeira iteração
            _, melhor_subconjunto, i_r, porcent_melhor_subconjunto = best_first(train_data, 3)
